 ...
 */
@WebServlet(name = "ClientInvoiceHistory", urlPatterns = {"/ClientInvoiceHistory"})
public class ClientInvoiceHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (hs.getAttribute("client") != null) {
                ...
                client = (pojos.Client) session.load(pojos.Client.class, client1.getIdClient());
            }

            Criteria invoiceCriteria = session.createCriteria(pojos.Invoice.class);
            invoiceCriteria.add(Restrictions.eq("client", client));
